...
class Form
{
    ...
    public static function _init()
    {
        ...
        static::$instance = static::forge('_default_', config());
    }
    ...
    public static function forge($fieldset = 'default', array $config = [])
    {
        ...
        return new FormInstance($fieldset, $config);
    }
    ...
    {
        return static::hidden(config('security.csrf_token_key', 'fuel_csrf_token'), \Security::fetch_token());
    }
